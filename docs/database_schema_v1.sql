...
CREATE TABLE customer_behavior_events (
    ...
    CONSTRAINT fk_behavior_events_campaign
...
-- ============================================================
--
-- Direct table access is temporarily allowed only for
-- operational data.
--
-- In the final production architecture, these permissions
-- should preferably be replaced by allowlisted read-only
-- views/API endpoints.
-- ============================================================
